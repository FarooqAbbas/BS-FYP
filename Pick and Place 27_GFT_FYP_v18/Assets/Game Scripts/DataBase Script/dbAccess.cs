...
public class dbAccess : MonoBehaviour {
    ...
    public void updatetData(string tblName, string colName, int val)
    {
        string query;
        query = "UPDATE " + tblName + " SET " + colName + " =" + val + " WHERE id=1 ";
        dbcmd = dbcon.CreateCommand();
        dbcmd.CommandText = query;
        reader = dbcmd.ExecuteReader();
    ...
    public void updateCloth(string tblName, string colName, string val)
    {
        string query;
        query = "UPDATE " + tblName + " SET " + colName + " =" + val + " WHERE id=1 ";
        dbcmd = dbcon.CreateCommand();
    ...
    public string getCloth(string tblName, string colName1, string colName2)
    {
        string clothName=null;

        string query;
        query = "select " + colName1 + " ," + colName2 + " from " + tblName + " where " + colName1 + " =1";
         dbcmd = dbcon.CreateCommand();
        dbcmd.CommandText = query;
        reader = dbcmd.ExecuteReader();
        while (reader.Read())
        {
            clothName = reader.GetString(1);
        }
    ...
    public int getCount(string tblName, string colName1,string colName2)
    {
        ...
        while (reader.Read())
        {
            ...
            string countS=reader["count"].ToString();
        }
