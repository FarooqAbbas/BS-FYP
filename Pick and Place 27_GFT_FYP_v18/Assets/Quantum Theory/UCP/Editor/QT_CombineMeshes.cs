...
//	[MenuItem("Window/Quantum Theory/Combine Meshes")]
	[MenuItem("Gulfam/Combine Meshes")]
	static void Init () 
     {
	...
	private bool castShadows=false,receiveShadows=false,addMeshCollider=true,isStatic=false,createParentGO=true;
	...
	{	
		...
		{	
			...
			addMeshCollider=EditorGUILayout.Toggle("Add Box Collider:",addMeshCollider);
			EditorGUILayout.EndHorizontal();
			EditorGUILayout.BeginHorizontal();
